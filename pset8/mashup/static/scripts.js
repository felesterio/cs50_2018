...
function addMarker(place)
{
    ...
    // get the list of links of place
    ...
    .done(function(data, textStatus, jqXHR)
    {
        ...
        if (data.length == 0)
	    {
		    list_articles = "No news available"
	    }
	    ...
	    else
	    {
            ...
            {
			    // Each list item is stored into list of articles
                list_articles += '<li><a href="' + data[i].link + '">' + data[i].title + '</a></li>'
            }
            list_articles += '</ul>'
	    }

	    marker.addListener('click', function() {
            showInfo(marker, list_articles);
		});
    });
}
